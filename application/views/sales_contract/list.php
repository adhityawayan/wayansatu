	...
	<div class="col-md-12">
		...
		<div class="portlet light portlet-fit portlet-datatable ">
			<div class="portlet-title">
				...
				<div class="actions">
                <div class="btn-group" >
                        <?php echo anchor('Sales_contract/form/','<i class="fa fa-pencil"></i> Tambah Data',array('class'=>'btn btn-circle btn-info btn-sm'));?>
                </div>
            </div>
			</div>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('Sales_contract/getDatatable/') ?>", // ajax source
            },
            "order": [
                [1, "asc"]
