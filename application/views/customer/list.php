	...
	<div class="col-md-12">
		...
		<div class="portlet light portlet-fit portlet-datatable ">
			<div class="portlet-title">
				...
				<div class="actions">
                <div class="btn-group" >
                        <?php echo anchor('Customer/form/','<i class="fa fa-pencil"></i> Tambah Data',array('class'=>'btn btn-circle btn-info btn-sm'));?>
                </div>
            </div>
			</div>
				...
				<div class="table-container">
					...
					<table class="table table-striped table-bordered table-hover table-checkable" id="mytable">
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td><input type="text" class="form-control form-filter input-sm" name="fax"></td>
                            ...
                            <td><input type="text" class="form-control form-filter input-sm" name="inisial"></td>
                            <td>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('Customer/getDatatable/') ?>", // ajax source
            },
            "order": [
                [1, "asc"]
