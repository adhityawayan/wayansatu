...
$pdf->Cell(45,8,': '.str_replace("PJ","SJ",@$penjualan->nomor_transaksi), 0, 1, 'L');

$pdf->Cell(120,8,strtoupper(@$penjualan->customer->nama), 0, 0, 'L');
$pdf->Cell(25,8,'No. Invoice', 0, 0, 'L');
$pdf->Cell(45,8,': '.@$penjualan->nomor_transaksi, 0, 1, 'L');
...
if($detail){
	...
	foreach($detail as $dt){
		...
		$pdf->SetXY(100, $y);
		$pdf->Cell(40,12,$dt->finishing, 1, 0, 'C');
		$pdf->Cell(30,12,number_format($dt->panjang,2,",","."), 1, 0, 'R');
		$pdf->Cell(30,12,number_format($dt->jumlah,0,",","."), 1, 1, 'R');
		$y = $y+12;
	}
}
$pdf->ln();$pdf->ln();$pdf->ln();
$pdf->Cell(50,8,@$penjualan->customer->nama, 0,0, 'L');
$pdf->Cell(90,8,'', 0, 0, 'L');
