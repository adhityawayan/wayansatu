	...
	<div class="col-md-12">
		<div class="portlet light portlet-fit portlet-datatable ">
			<div class="portlet-title">
				...
				<div class="actions">
					<div class="btn-group" >
							<?php echo anchor('S_user/form/','<i class="fa fa-pencil"></i> Tambah Data',array('class'=>'btn btn-circle btn-info btn-sm'));?>
					</div>
				</div>
			</div>
					...
					<table class="table table-striped table-bordered table-hover table-checkable" id="mytable">
						<thead>
							...
							<tr role="row" class="filter">
								...
								<td><select name='tipe' class='form-control form-filter select2-ajax' data-url='<?php echo site_url('form/dd/Type_user_model') ?>'></select></td>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('S_user/getDatatable/') ?>", // ajax source
            },
            "order": [
                [1, "asc"]
